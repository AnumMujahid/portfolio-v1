  ...
  const feedbacks = [
    {
      ...
      bg: "#ccffc3",
      border: "#77fa60",
      text: "Fatima is an energetic and a highly motivated youth. She can utilize good communication skills and technical expertise to positively contribute to the organizations' objectives.",
      name: "Farah Tahir",
    ...
    },
    {
      ...
      bg: "#f5f5f5",
      border: "#77fa60",
      text: "During her tenure, Fatima consistently demonstrated exceptional skills, dedication, and professionalism, making valuable contributions to our organization.",
